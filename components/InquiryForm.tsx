...
const LEADS_API_URL = "https://app.obrtio.si/api/forms/a0b2fdf6-20a5-4cdb-a958-30b500709001/submissions";
...
export default function InquiryForm({ intro, note, id = "povprasevanje" }: { intro: string; note: string; id?: string }) {
  ...
  const submit = async (e: FormEvent) => {
    ...
    try {
      ...
      formData.set("name", f.ime);
      formData.set("phone", f.tel);
      formData.set("email", f.email);
      formData.set("location", f.lokacija);
