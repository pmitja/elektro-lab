...
export const metadata: Metadata = {
  title: { absolute: "Kontakt | Električar Maribor in okolica | Elektro Lab" },
  description:
    "Kontaktirajte Elektro Lab za elektro storitve v Mariboru in okolici. Pošljite povpraševanje za elektroinštalacije, prenove, meritve, razsvetljavo ali vzdrževanje.",
          ...
          <div data-gsap-hero-copy>
            ...
            <div style={s("display:flex;flex-direction:column;gap:14px;max-width:440px")}>
              <a href={`tel:${TELEFON}`} className="hv-border-soft" style={s("display:flex;align-items:center;gap:16px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.13);border-radius:14px;padding:16px 18px;text-decoration:none")}>
                <span style={s("width:42px;height:42px;border-radius:11px;background:#FFC900;display:flex;align-items:center;justify-content:center;flex:none")}>
                  <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="#0B1526" strokeWidth="2" strokeLinecap="round"><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 4.2 2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .4 2 .7 2.9a2 2 0 0 1-.5 2.1L8.1 10a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.4c.9.3 1.9.6 2.9.7a2 2 0 0 1 1.6 2z"></path></svg>
                </span>
              ...
              <a href={`mailto:${EMAIL}`} className="hv-border-soft" style={s("display:flex;align-items:center;gap:16px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.13);border-radius:14px;padding:16px 18px;text-decoration:none")}>
                <span style={s("width:42px;height:42px;border-radius:11px;background:#FFC900;display:flex;align-items:center;justify-content:center;flex:none")}>
                  <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="#0B1526" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 5h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1z"></path><path d="M3.5 6.5L12 13l8.5-6.5"></path></svg>
                </span>
                <span style={s("display:flex;flex-direction:column;gap:2px")}>
              ...
              <div style={s("display:flex;align-items:center;gap:16px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.13);border-radius:14px;padding:16px 18px")}>
                <span style={s("width:42px;height:42px;border-radius:11px;background:#FFC900;display:flex;align-items:center;justify-content:center;flex:none")}>
                  <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="#0B1526" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 21s-7-5.5-7-11a7 7 0 0 1 14 0c0 5.5-7 11-7 11z"></path><circle cx="12" cy="10" r="2.5"></circle></svg>
                </span>
                <span style={s("display:flex;flex-direction:column;gap:2px")}>
        ...
        <div className="amx-2col" style={s("max-width:1200px;margin:0 auto;padding:88px 24px;display:grid;grid-template-columns:1fr 1fr;gap:56px;align-items:center")}>
          <div>
            ...
            <h2 style={s("font:700 clamp(26px,3vw,36px)/1.12 'Space Grotesk',sans-serif;letter-spacing:-0.02em;margin:0 0 18px")}>
              Raje <span style={s("background:linear-gradient(transparent 58%,#FFC900 58%)")}>pokličete</span>?
            </h2>
            <p style={s("font:400 16px/1.7 'Instrument Sans',sans-serif;color:#47536B;margin:0 0 26px")}>
              ...
              <a href={`tel:${TELEFON}`} style={s("color:#0B1526;font-weight:600;text-decoration:none;border-bottom:2px solid #FFC900")}>{TELEFON}</a>. Če se ne uspemo oglasiti, vas pokličemo nazaj v najkrajšem možnem času.
            </p>
            <a href={`tel:${TELEFON}`} className="hv-bg-navy" style={s("display:inline-flex;align-items:center;gap:9px;background:#0B1526;color:#fff;font:600 15px 'Instrument Sans',sans-serif;padding:14px 26px;border-radius:12px;text-decoration:none")}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FFC900" strokeWidth="2" strokeLinecap="round"><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 4.2 2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .4 2 .7 2.9a2 2 0 0 1-.5 2.1L8.1 10a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.4c.9.3 1.9.6 2.9.7a2 2 0 0 1 1.6 2z"></path></svg>
              Pokliči zdaj
            </a>
          </div>
          <div style={s("background:#F5F6F8;border:1px solid rgba(11,21,38,.06);border-radius:20px;padding:34px 30px")}>
            ...
            <div style={s("display:flex;flex-wrap:wrap;gap:8px;margin-top:20px")}>
              {OBMOCJA.map((o) => (
                <span key={o} style={s("font:500 13px 'Space Grotesk',sans-serif;color:#47536B;background:#fff;border:1px solid rgba(11,21,38,.1);border-radius:999px;padding:7px 14px")}>{o}</span>
              ))}
            </div>
          </div>
        </div>
