...
export const metadata: Metadata = {
  title: { absolute: "O nas | Električar Maribor in okolica | Elektro Lab" },
  description:
    "Spoznajte Elektro Lab, elektro podjetje za zanesljive elektro storitve v Mariboru in okolici. Strokovna izvedba, jasna komunikacija in varne rešitve.",
      ...
      <section style={s("background:#0B1526;background-image:linear-gradient(90deg,rgba(11,21,38,.98),rgba(11,21,38,.8)),linear-gradient(rgba(255,255,255,.045) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.045) 1px,transparent 1px),url('/generated/soft-electrical-bg.webp');background-size:cover,46px 46px,46px 46px,cover;background-position:center;position:relative;overflow:hidden")}>
        ...
        <div data-gsap-hero data-gsap-hero-copy style={s("max-width:1200px;margin:0 auto;padding:76px 24px 68px;position:relative")}>
          ...
          <p style={s("font:400 17px/1.65 'Instrument Sans',sans-serif;color:rgba(255,255,255,.72);margin:0;max-width:640px")}>
            Elektro Lab izvaja elektro storitve za domove, stanovanja, novogradnje in podjetja na območju Maribora in okolice. Naš cilj je, da je vsako elektro delo izvedeno strokovno, pregledno in varno.
          </p>
        </div>
      </section>
        ...
        <div className="amx-2col" style={s("max-width:1200px;margin:0 auto;padding:88px 24px;display:grid;grid-template-columns:1fr 1.2fr;gap:56px;align-items:center")}>
          <div>
            ...
            <h2 style={s("font:700 clamp(28px,3.2vw,38px)/1.12 'Space Grotesk',sans-serif;letter-spacing:-0.02em;margin:0 0 26px")}>
              Naš <span style={s("background:linear-gradient(transparent 58%,#FFC900 58%)")}>pristop</span>
            </h2>
          ...
          <div style={s("position:relative")}>
            <div style={s("position:relative;width:100%;height:380px;border-radius:18px;overflow:hidden;display:block;box-shadow:0 18px 50px rgba(11,21,38,.14)")}>
            ...
            <div style={s("position:absolute;bottom:-16px;left:-14px;background:#FFC900;border-radius:14px;padding:14px 18px;display:flex;align-items:center;gap:10px;box-shadow:0 12px 30px rgba(11,21,38,.2)")}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0B1526" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3l8 3v6c0 4.8-3.4 7.7-8 9-4.6-1.3-8-4.2-8-9V6z"></path><path d="M9 12l2 2 4-4.5"></path></svg>
              <span style={s("font:600 13.5px 'Space Grotesk',sans-serif;color:#0B1526")}>Pravilno že prvič</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={s("background:#F5F6F8;background-image:linear-gradient(180deg,rgba(245,246,248,.92),rgba(245,246,248,.97)),url('/generated/soft-electrical-bg.webp');background-size:cover;background-position:center")}>
        <div style={s("max-width:1200px;margin:0 auto;padding:88px 24px")}>
          ...
          <h2 style={s("font:700 clamp(28px,3.2vw,38px)/1.12 'Space Grotesk',sans-serif;letter-spacing:-0.02em;margin:0 0 44px;text-align:center")}>
            Kaj nam je <span style={s("background:linear-gradient(transparent 58%,#FFC900 58%)")}>pomembno</span>?
          </h2>
          <div style={s("display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:18px")}>
            {VREDNOTE.map((v) => (
              <div key={v.naslov} style={s("background:#fff;border:1px solid rgba(11,21,38,.07);border-radius:18px;padding:28px 24px;display:flex;flex-direction:column;gap:12px")}>
            ...
            <div style={s("width:100%;max-width:380px;aspect-ratio:1;border-radius:50%;border:1px dashed rgba(255,255,255,.25);display:flex;align-items:center;justify-content:center;position:relative")}>
              <div style={s("width:66%;aspect-ratio:1;border-radius:50%;border:1px dashed rgba(255,255,255,.35);display:flex;align-items:center;justify-content:center")}>
                <div style={s("display:flex;flex-direction:column;align-items:center;gap:10px")}>
                  <span style={s("width:48px;height:48px;border-radius:50%;background:#FFC900;display:flex;align-items:center;justify-content:center")}>
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="#0B1526"><polygon points="13,2 4,14 11,14 9,22 20,9 13,9"></polygon></svg>
                  </span>
